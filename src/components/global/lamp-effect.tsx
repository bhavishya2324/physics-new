  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-2 bg-gradient-to-br from-neutral-300 to-neutral-500 pb-0 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
      Your Gateway to 
